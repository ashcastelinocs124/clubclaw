...
Our weekly lecture series covers the full stack of agentic AI:

- **Week 1** — Intro to Club and Foundations of Agentic AI Systems
- **Week 2** — Prompt Engineering (Advanced & Structured) & Tool Calling
- **Week 3** — Memory Management (Short, Long, Hybrid)
- **Week 4** — Retrieval-Augmented Generation (RAG) & Advanced RAG
- **Week 5** — Context Graphs
- **Week 6** — Multi Agent Architectures
- **Week 7** — Context Engineering over Coding Agents
- **Week 8** — Reinforcement Learning over Agents
- **Week 9** — Eval Systems for Agents
- **Week 10** — MCP (Model Context Protocol) & Agent Infrastructure
- **Week 11** — Voice Agents
