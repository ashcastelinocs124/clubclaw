...
description: Use when the user wants a complete end-to-end development cycle for a complex feature, including architecture planning, implementation, code review, and documentation. Triggers on "full coding workflow", "complete development cycle", or multi-stage development requests.
---
