...
description: Use when code has been reviewed and approved and needs comprehensive testing validation. Covers unit, integration, system, and security tests. Triggers on "test this", "validate the implementation", or before deploying significant features.
---
...
**Skip for:** Writing code (use code-implementation), reviewing code (use code-reviewer), explaining code (use tutor)
