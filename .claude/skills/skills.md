...
│   ├── SKILL.md
│   └── examples.md
├── code-architect/                ← DEPRECATED (merged into code-implementation)
│   └── SKILL.md
├── code-implementation/           ← Plan → approve → code → review
│   └── SKILL.md
...
│   └── SKILL.md
├── superdesign/                   ← Design agent for UI/UX
│   ├── SKILL.md
│   ├── INIT.md
│   └── SUPERDESIGN.md
├── linkedin-post/                 ← LinkedIn post writing with guided questions
│   └── SKILL.md
...
| `/code-implementation` | Plan → approve → implement (TDD) → verify → code-reviewer agent |
...
| `/superdesign` | Design agent for frontend UI/UX — create projects, design drafts, iterate variations |
| `/linkedin-post` | Write LinkedIn posts with guided topic/audience/tone questions |
| `/deploy` | Production deployment with pre-flight checks, verification, and rollback |
